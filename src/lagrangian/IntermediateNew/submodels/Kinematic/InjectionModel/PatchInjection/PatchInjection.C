...
:
    ...
    ppp0_(readLabel(this->coeffDict().lookup("ppp0"))),
    flowRateProfile_
    (
...
)
{
    ...
    //parcel.U() = U0_;
    //Hesam Tofighian Hesam Tofighian Hesam Tofighian Hesam Tofighian Hesam Tofighian Hesam Tofighian Hesam Tofighian Hesam Tofighian Hesam Tofighian Hesam Tofighian Hesam Tofighian Hesam Tofighian Hesam Tofighian 
    parcel.U() = UInterp_->interpolate(parcel.position(), parcel.currentTetIndices());
    // set particle diameter
    parcel.d() = sizeDistribution_->sample();
    parcel.ppp() = ppp0_;
    parcel.PosI() = parcel.position();
}
