...
//Hesam Hesam Tofighian Tofighian Hesam Hesam Tofighian Tofighian Hesam Hesam Tofighian Tofighian Hesam Hesam Tofighian Tofighian Hesam Hesam Tofighian Tofighian Hesam Hesam Tofighian Tofighian
//Hesam Hesam Tofighian Tofighian Hesam Hesam Tofighian Tofighian Hesam Hesam Tofighian Tofighian Hesam Hesam Tofighian Tofighian Hesam Hesam Tofighian Tofighian Hesam Hesam Tofighian Tofighian
template<class ParcelType>
...
void Foam::KinematicParcel<ParcelType>::readFields(CloudType& c)
{
    ...
    IOField<vector> PosI(c.fieldIOobject("PosI", IOobject::MUST_READ));
    c.checkFieldIOobject(c, PosI);

    IOField<label> ppp(c.fieldIOobject("ppp", IOobject::MUST_READ));
    c.checkFieldIOobject(c, ppp);
...
void Foam::KinematicParcel<ParcelType>::writeFields(const CloudType& c)
{
    ...
    IOField<vector> PosI(c.fieldIOobject("PosI", IOobject::NO_READ), np);
    IOField<label> ppp(c.fieldIOobject("ppp", IOobject::NO_READ), np);
